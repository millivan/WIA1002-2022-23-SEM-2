public class ArrayBag<T> implements BagInterface<T> {
    ...
    /** Creates a new bag that combines the contents of this bag and anotherBag. (Question 3)
    ...
    /** Creates a new bag that contains those objects that occur
     in both this bag and anotherBag. (Question 4)
    ...
    /** Creates a new bag of objects that would be left in this bag
     after removing those that also occur in anotherBag. (Question 5)
